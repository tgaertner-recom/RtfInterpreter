...
using System.Text;
using Intenso.Rtf.Sys.Logging;

namespace Intenso.Rtf.Parser.Parser
{
	...
	public class RtfParserListenerLogger : RtfParserListenerBase
	{
		...
		private static readonly ILogger systemLogger = Intenso.Rtf.Sys.Logging.Logger.GetLogger( typeof( RtfParserListenerLogger ) );
