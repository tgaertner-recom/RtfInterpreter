...
using System.Text;
using Itenso.Rtf.Sys.Logging;

namespace Itenso.Rtf.Parser.Parser
{
	...
	public class RtfParserListenerLogger : RtfParserListenerBase
	{
		...
		private static readonly ILogger systemLogger = Itenso.Rtf.Sys.Logging.Logger.GetLogger( typeof( RtfParserListenerLogger ) );
